...
import CollectionStage from '../WatchStage'
import ViewModeToggle from '../ViewModeToggle'
import V4RightGrid from './V4RightGrid'

/**
 * V4 — Editorial+ page.
 * Mirrors V3 (CurrentHero) shell: chocolate hero with FairBackdrop ambient,
 * meta strip + ViewModeToggle, hero grid (H1 + 4 KPIs), and the main grid
 * with sticky CollectionStage left + V4RightGrid right.
 *
 * Per the brief, the only difference from V3 is the right grid component
 * and a tighter Cormorant-italic editorial layer (rendered inside V4RightGrid).
 */
